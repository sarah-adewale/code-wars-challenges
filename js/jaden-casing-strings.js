...
// The Karate Kid (2010) and After Earth (2013). Jaden is also known for some of his 
// philosophy that he delivers via Twitter. When writing on Twitter, he is known for 
// almost always capitalizing every word. For simplicity, you'll have to capitalize each 
...
//p: string
//r: capitalize the strings
//e: 
//p: its an object, use this. split string and capitalize string 
...
function jadenCase(string){
   string = string.split(' ')
    return string.map(item => item[0].toUpperCase() + item.slice(1)).join(' ')
}
