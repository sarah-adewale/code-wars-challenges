...
//   return sum;
// }
// As you see, there are three parts in the parentheses, separated by ";". The 
// first part, var sum=0,num=1, is the initialization. This part will run before 
// the loop starts. The second part, num<=100 is the conditional expression. The 
// conditional expression is checked before the start of each time through the 
// loop. When the value of the expression is false, the loop will be terminated. 
// The third part, num++ will run after the code block, and is usually used for 
...
//                            false|
//                        loop terminated
// When you need to traverse an array, you can use the for loop to access each 
// element using its index. Here's an example:
...
//create a function, create an empty arr called odd, and another empty array called
// even. create a loop thru the array to check if individual array is an odd number of 
//an even number
