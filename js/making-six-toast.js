...
// Define a function that counts how many more (or less) pieces of toast you need 
// in the toasters. Even though you need more or less, the number will still be 
// positive, not negative.

// Examples:
// You must return the number of toast the you need to put in (or to take out). In 
// case of 5 you can still put 1 toast in:
...
function sixToast(num) {
  // you code here
  return num === 6 ? 0 : num < 6 ? Math.abs(num - 6) : num - 6
}
