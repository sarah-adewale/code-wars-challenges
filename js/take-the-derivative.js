...
// exponent. Then, it has to print out an expression (like 28x^7). "^1" should not be 
...
//parameter - 2 parameters number
//return - string represented like "56x^7"
//multiply 2 numbers, substract 1 from the exponent
