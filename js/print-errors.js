...
// string
// string: errors divided by the length of string 
// define characters a - m
// if string does not include character, return character not included plus / plus 
// length of string

function printerError(s) {
    let char = 'abcdefghijklm'
    s = s.split('')
    let error = s.filter((item) => !char.includes(item)).join('')
