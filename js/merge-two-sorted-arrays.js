...
// * [1, 3, 5, 7, 9, 11, 12], [1, 2, 3, 4, 5, 10, 12] -> [1, 2, 3, 4, 5

function mergeArrays(arr1, arr2) {
  mergedSortedArrays = [].concat(arr1, arr2).sort((a,z) => a - z)
  filterdMergedSortedArrays = mergedSortedArrays.filter(function(item, index, arr){
      return !index || item != arr[index - 1]
  })
  return filterdMergedSortedArrays
}
